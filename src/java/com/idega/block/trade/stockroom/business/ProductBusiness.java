...
public interface ProductBusiness extends IBOService {
	 ...
	 */
	public boolean clearProductCache(String supplierId) throws java.rmi.RemoteException;
	public boolean clearProductCache(String supplierId, String remoteDomainToExclude) throws java.rmi.RemoteException;
